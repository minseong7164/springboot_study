...
//        );
        ...
        int startIndex = (searchStudyDto.getPage() - 1) * searchStudyDto.getPage();
        List<Student> newStudents = new ArrayList<>();
        for (int i = 0; i < (foundStudents.size() < searchStudyDto.getPage() ? foundStudents.size() : searchStudyDto.getPage()); i++) {
            try {
